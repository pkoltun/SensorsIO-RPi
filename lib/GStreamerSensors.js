...
function Camera(logger, gstreamerRoot, singleClient) {
...
function Microphone(logger, gstreamerRoot,singleClient) {
...
function Speaker( logger, gstreamerRoot, singleClient) {
